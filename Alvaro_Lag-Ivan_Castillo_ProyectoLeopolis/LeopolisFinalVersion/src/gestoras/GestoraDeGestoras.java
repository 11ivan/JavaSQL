...
public class GestoraDeGestoras {
    ...
    public GestoraDeGestoras() {
        //Abrimos la conexion con la base de datos LA ABRIMOS AQUÍ PORQUE LA NECESITAMOS PARA ENVIARSELA A LA GESTORA DE MATRIMONIOS
    ...
    */
    public void actualizaDB(ArrayList<Asiento> listaAsientos){       
        ...
        //Escribimos las incidencias en LOG
    ...
    */
    public void insertMatrimonio(Asiento asiento){
        ...
        matrimonios.setIDConyuge1(getCiudadane(asiento.getCiudadane().get(0).getID()));
